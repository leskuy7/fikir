    ...
    <div className="kart-modu">
      ...
      {yukleniyor && (
        <div className="kart-modu__yukleniyor">
          <YukleniyorSpinner metin="Fikir kartları hazırlanıyor..." skeleton adet={6} />
        </div>
      )}
      ...
      {!yukleniyor && kartlar.length > 0 && (
        <>
          <p className="kart-modu__baslik">
            <span className="kart-modu__baslik-sayi">{kartlar.length}</span> fikir &mdash; <em>&ldquo;{konu}&rdquo;</em>
          </p>
